...
namespace MRK {
    namespace GUI {
        ...
        void MRKGuiBaseButton::Draw(MRKUIcontext *context) {
            ...
            MRKUIpaint bg = MRKUILinearGradient(context, Position().X(), Position().Y(),
                                                Position().X(),
            ...
            MRKUIRoundedRect(context, Position().X() + 0.5f,
                             Position().Y() + (m_Down ? 0.5f : 1.5f),
                             m_Size.X() - 1,
            ...
            if (m_Icon) {
                ...
                if (1024 > m_Icon) {
                    ...
                    MRKUIpaint imgPaint = MRKUIImagePattern(context,
                                                            iconPos.X(), iconPos.Y() - ih / 2, iw,
                                                            ih,
                                                            0, m_Icon,
                                                            m_Interactable ? 0.5f : 0.25f);
